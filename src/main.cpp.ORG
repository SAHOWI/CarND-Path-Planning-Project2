...
#include "spline.h" // include the spline library
...
int lane = 1;
          ...
          double ref_vel = 0; // new version with JERK suppression at the beginning
    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // to be removed during next code cleanout: double declaration
          // vector<double> next_x_vals;
          // vector<double> next_y_vals;
          ...
          for (int i = 1; i <= 50 - previous_path_x.size(); i++) {
            ...
            double y_point = (ref_y * sin(ref_yaw) + ref_y * cos(ref_yaw));
